...
internal class GetOrderByIdWithDetailsRequestHandler : IRequestHandler<GetOrderByIdWithDetailsRequest, OrderDTO>
{
    private readonly IOrderRepository _repository;

    public GetOrderByIdWithDetailsRequestHandler(IOrderRepository repository)
    {
        _repository = repository;
    }

    public async Task<OrderDTO> Handle(GetOrderByIdWithDetailsRequest request, CancellationToken cancellationToken)
    {
